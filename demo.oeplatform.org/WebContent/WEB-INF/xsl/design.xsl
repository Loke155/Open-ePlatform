	...
	<xsl:template match="document">
		...
		<xsl:text disable-output-escaping="yes"><![CDATA[<!--[if gt IE 8]><!--><html class="no-js"><!--<![endif]-->]]></xsl:text>
			...
			<head>
				...
				<meta name="keywords" content="Open e-Platform" />
				...
				<title>
					...
					<xsl:text>demo.oeplatform.org</xsl:text>
				</title>
				...
				<xsl:if test="not(scripts/script[src='/static/global/jquery/jquery.js'])">
				...
				<xsl:text disable-output-escaping="yes"><![CDATA[<![endif]-->]]></xsl:text>
			 	...
			 	<script type="text/javascript" src="{/document/requestinfo/contextpath}/js/plugins.js"></script>
			  	<script type="text/javascript" src="{/document/requestinfo/contextpath}/js/init.js"></script>
